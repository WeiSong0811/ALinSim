...
import json
from utils import data_process, data_process_meta, active_learning, generation_pool_fea
...
def main():  
    ...
    X_t = X_pool_filtered
    fea_df = pd.read_csv(f'../data/fea_output_{random_state}.csv')
    ...
    query_idx_all, query_time_all, metrics_all = active_learning(estimators_list, X_t, X_val, y_val, n_initial,
